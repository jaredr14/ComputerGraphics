...
function initTextures() {
    ...
    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"furpattern.jpg") ;

    textureArray.push({}) ;
    loadImageTexture(textureArray[textureArray.length-1],"Grass.jpg") ;

    textureArray.push({}) ;
    loadImageTexture(textureArray[textureArray.length-1],"leopardtexture.jpg") ;
...
gPush() ;
{
  //gRotate((Math.sin(TIME) * 25) + 5, 0, 0, 1);
    gTranslate(-2.6,1.75,0) ;
    gRotate(20, 0, 0 ,1);
    gScale(0.5,1.5,0.5);
    setColor(vec4(1.0,0.0,0.0,1.0)) ;
    //gRotate(TIME*180/3.14159,0,1,0) ;
